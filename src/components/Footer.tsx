      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-center mb-6">
          <Link
            ...
            smooth={true}
            duration={500}
            className="w-12 h-12 rounded-full bg-primary-600 hover:bg-primary-700 transition-colors flex items-center justify-center cursor-pointer"
          >
            <ChevronUp size={24} />
          </Link>
        </div>
        <div className="text-center">
          <h3 className="font-mono text-2xl mb-2">
            arish<span className="text-primary-500">@dev</span>
          </h3>
          ...
          <div className="border-t border-gray-800 pt-6">
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} Arish. All rights reserved.
            </p>
            <p className="text-gray-600 text-xs mt-2 flex items-center justify-center">
              Made with <Heart size={12} className="mx-1 text-red-500" /> using React & Tailwind CSS
            </p>
          </div>
        </div>
      </div>
